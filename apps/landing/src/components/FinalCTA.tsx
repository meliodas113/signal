...
export function FinalCTA() {
  return (
    <section id="get" className="mx-auto max-w-[1140px] px-7 py-16 md:py-24">
      <Reveal>
        <div className="rounded-[22px] border border-line bg-surface bg-[radial-gradient(600px_300px_at_50%_0%,rgba(194,245,63,0.08),transparent_65%)] px-8 py-[70px] text-center">
